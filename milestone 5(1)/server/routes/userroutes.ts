...
let userroute = express.Router(); //create a router object we use this to serve all our requests
...
//      .get(getBookById)
//      .delete(deleteBook)
// route.route("/books/by/author/:author")
//      .get(searchByAuthor)
// route.route("/books/by/title/:title")  
//      .get(searchByTitle)
// route.route("/books/by/rating/:rating")  
//      .get(searchByRating)
//      route.route("/priced/:min/:max")
//      .get(searchByPrice) 
userroute.route("/registration")
     .post(registration)
