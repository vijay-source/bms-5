...
var bookroute = express_1.default.Router(); //create a router object we use this to serve all our requests
bookroute.use(express_1.default.json());
bookroute.route("/books")
    .get(bookcontroller_1.getAllBooks)
    .post(bookcontroller_1.addNewBook);
...
bookroute.route("/books/by/author/:author")
    .get(bookcontroller_1.searchByAuthor);
bookroute.route("/books/by/title/:title")
    .get(bookcontroller_1.searchByTitle);
bookroute.route("/books/by/rating/:rating")
    .get(bookcontroller_1.searchByRating);
bookroute.route("/priced/:min/:max")
    .get(bookcontroller_1.searchByPrice);
